...
The Client Portal is one of three systems in the overall Online Order Solution:

```
Client ──▶ Client Portal ──▶ Order Management System ──▶ Product Management System
                │                                              │
             Products DB                                   Data Lake
```

- **New Order** — sent asynchronously from the Client Portal to the Order Management System
- **Order Update** — sent asynchronously back to the Client Portal as order status changes
- **Get Products** — synchronous call to the Product Management System's catalogue
